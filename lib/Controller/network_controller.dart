...
//********************** onit method **********************//
  ...
  //   if (status != null) {
  //     if (status.canUpdate) {
  //       // Get.offAllNamed(Routes.APP_UPDATE_SCREEN, arguments: status);
  //       Get.toNamed(Routes.APP_UPDATE_SCREEN, arguments: status);
  //     }
  //   }
  // }
...
//********************** update connection status **********************//
  ...
  showSyncDialog() async {
    if (isInternetAvailable.value == true) {
      // final newVersion = NewVersionPlus(androidId: 'com.pianohouse', iOSId: 'com.pianohouse');
      // Timer(const Duration(milliseconds: 800), () async {
      //   await checkNewVersion(newVersion);
      // });
